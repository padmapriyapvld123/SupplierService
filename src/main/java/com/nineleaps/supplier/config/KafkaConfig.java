...
public class KafkaConfig {
	...
	@Bean
	public ConsumerFactory<String, OrderConsumer> supplierConsumerFactory() {

		JsonDeserializer<OrderConsumer> deserializer = new JsonDeserializer<>(OrderConsumer.class);
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, OrderConsumer> supplierKafkaListenerFactory() {
